...
@section('content')
    ...
    <form action="{{ route('phonebooks.update',$data->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="number" placeholder="Number">{{ $data->number }}</textarea>
                </div>
            </div>
